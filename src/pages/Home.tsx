...
import spotlightImg from "src/imports/IMG_0292.png";
import { SERVICES, ServiceCard } from "@/shared";

const PREVIEW_VIDEOS = [
  {
    id: "dm1",
    src: "7496731421680176389",
    label: "Digital Marketing",
    title: "VERO LOUNGE — Grand Opening",
  },
  {
    id: "dm2",
    src: "7617497044097322247",
    label: "Digital Marketing",
    title: "Star Dental Clinic",
  },
  {
    id: "wf1",
    src: "7644792519728827656",
    label: "Wedding Films",
    title: "DOT Films — Wedding",
  },
  {
    id: "wf2",
    src: "7644420136610385170",
    label: "Wedding Films",
    title: "DOT Films — Wedding",
  },
  {
    id: "bp1",
    src: "7648901410188201224",
    label: "Birthday Party",
    title: "Birthday Celebration",
  },
  {
    id: "bp2",
    src: "7642583255308307719",
    label: "Birthday Party",
    title: "Birthday Celebration",
  },
  {
    id: "se1",
    src: "7504161487066238214",
    label: "School Event",
    title: "Sheba 25 Seniors",
  },
  {
    id: "se2",
    src: "7533135291566050565",
    label: "School Event",
    title: "Sheba 25 Seniors",
  },
  {
    id: "ms1",
    src: "7670778321734552839",
    label: "Modeling Shoots",
    title: "DOT Films — Modeling",
  },
  {
    id: "ms2",
    src: "7670043325566602503",
    label: "Modeling Shoots",
    title: "DOT Films — Modeling",
  },
];
    ...
    const obs = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting && !requested.current) {
          ...
          obs.disconnect();
          fetch(
            `https://www.tiktok.com/oembed?url=${encodeURIComponent(`https://www.tiktok.com/@tiktok/video/${src}`)}`,
          )
        ...
        {playing ? (
          ...
          <button
            ...
            style={{
              ...
              cursor: "pointer",
              background: thumb
                ? `#111 url(${thumb}) center/cover no-repeat`
                : "#111",
              display: "flex",
              flexDirection: "column",
              alignItems: "center",
        ...
        >
          ...
          <div
            ...
            style={{
              zIndex: 1,
              background:
                "linear-gradient(to right, rgba(0,0,0,0.80) 40%, rgba(0,0,0,0.35) 100%)",
            }}
          />
          <div
            className="absolute inset-0"
          ...
          <div
            ...
            style={{
              zIndex: 1,
              backgroundImage:
                "radial-gradient(at 10% 30%, rgba(124, 58, 237, 0.15) 0%, rgba(0, 0, 0, 0) 60%)",
            }}
          />

          <div
            className="relative w-full max-w-7xl mx-auto px-6 pt-24 pb-16"
            style={{ zIndex: 2 }}
          >
            <div className="max-w-2xl">
              ...
              />
              <p
                className="text-lg md:text-2xl leading-relaxed mb-8 font-light"
                style={{
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p
                  ...
                  style={{ color: "#9ca3af" }}
                >
                  We curate cinematic masterworks, immersive event chronicles,
                  and evocative brand narratives. By harmonizing technical
                  mastery with creative intuition, we forge unparalleled visual
                  experiences.
                </p>
                <div className="flex items-center gap-4 mt-2">
                  <a
                    href="https://www.tiktok.com/@dotfilms?is_from_webapp=1&sender_device=pc"
                    target="_blank"
                    rel="noreferrer"
                  ...
                  <a
                    href="https://www.instagram.com/dot_film_production?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center justify-center w-10 h-10 rounded-full"
                    style={{
              ...
              <div className="relative">
                ...
                <div
                  className="absolute -top-4 -right-4 px-5 py-4 rounded-xl"
                  style={{
                    background: "#1a1a1a",
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              >
                A glimpse across every category we cover — from weddings to
                brand campaigns.
              </p>
            </div>
            <div
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-6 md:gap-14 items-center">
              <div className="relative" style={{ perspective: "1400px" }}>
                ...
                >
                  <img
                    src={spotlightImg}
                    alt="DOT Creative filming a wedding celebration"
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(to top, rgba(10,10,10,0.55) 0%, transparent 45%)",
                    }}
                  />
                </div>
                <div
                  ...
                  style={{
                    inset: "-18px",
                    borderRadius: "32px 70px 32px 70px",
              ...
              <div>
                ...
                <h2
                  className="text-xl md:text-5xl font-bold mb-3 md:mb-6 leading-tight"
                  style={{ fontFamily: "Poppins, sans-serif" }}
                >
                  Moments That{" "}
                  <span className="text-gradient">Last Forever</span>
                </h2>
                <p
                  className="text-xs md:text-base leading-relaxed mb-4 md:mb-6 hidden md:block"
                  style={{ color: "#9ca3af" }}
                >
                  From the first dance to the quiet glances in between, we
                  capture weddings the way they feel — cinematic, intimate, and
                  alive. Every frame is lit, framed, and edited to keep the
                  emotion of the day long after the celebration ends.
                </p>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p
                ...
                style={{ color: "#9ca3af" }}
              >
                The people behind the lens — passionate creators who live for
